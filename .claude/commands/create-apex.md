...
- Check CRUD/FLS with `SECURITY_ENFORCED` in SOQL
...
1. Deploy: `sf project deploy start --source-dir force-app/main/default/classes/ClassName.cls force-app/main/default/classes/ClassNameTest.cls`
2. Run tests: `sf apex run test --class-names ClassNameTest --synchronous --result-format human`

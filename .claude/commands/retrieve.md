...
**Retrieve by manifest (package.xml):**
```
sf project retrieve start --manifest manifest/package.xml --wait 10
```
...
5. Suggest next steps: review changes, commit, or deploy back if modifications are made
